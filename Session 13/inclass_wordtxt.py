...
def most_common(hist):
    ...
    temp.sort()     #default sorting is ascending smallest to largest
    temp.reverse()  #we actually want largest to smallest
    return temp
#for testing
...
def main():
    hist = process_file('Huck Finn.txt', skip_header=True)
